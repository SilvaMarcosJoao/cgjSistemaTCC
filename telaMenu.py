...
class MenuTela(Funcionalidades, Validadores):
    ...
    def widgets_menu_left(self) -> None:
        ...
        self.btn_ger_os = Button(self.frameMenu_left, image=self.img_os, text='Ordem de Serviço', relief='groove', font=('Verdana', 7, 'bold'), compound='left', anchor='center', bg='#505050', command=lambda: self.indicate(self.widgets_os))
    ...
    def widgets_categoria(self) -> None:
        ...
        self.scrollListaCat.place(relx=0.72, rely=0.48, relwidth= 0.02, relheight=0.3)
    ...
    def widgets_produto(self):
        ...
        self.popupMenu.place(relx=0.57, rely=0.02, relwidth=0.05, height=25)
        ...
        self.btn_salvar_produto.place(relx=0.84, rely=0.04, relwidth=0.09, height=40)
        ...
        self.btn_lista_produto.place(relx=0.84, rely=0.12, relwidth=0.09, height=40)
        ...
        self.btn_alterar_produto.place(relx=0.84, rely=0.20, relwidth=0.09, height=40)
        ...
        self.btn_excluir_produto.place(relx=0.84, rely=0.28, relwidth=0.09, height=40)
    ...
    def widgets_os(self):
        self.validaEntradas()
        self.img_crud()
        self.frameCadOS = Frame(self.frameMenu_right, bd=1,background='#d9d9d9')
        self.frameCadOS.place(relx=0.01, rely=0.01, relwidth=0.98, relheight=0.47)
