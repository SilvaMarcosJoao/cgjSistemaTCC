...
class TelaItens(Funcionalidades, Venda):
    ...
    def widgets_tela_itens(self):
        ...
        self.comboxaddItens = ttk.Combobox(self.add_frame, values=self.prodRecebidos)
        ...
        self.btn_add_prod = Button(self.add_frame, text='Adicionar', relief='groove', font=('Roboto', 10, 'bold'), compound='left', anchor='center', bg='#f3f3f3')
